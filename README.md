...
6. If you want to test the batch version, invoke ```RUSTFLAGS="-C target-cpu=native" cargo test --release -- --nocapture npirbatch::tests::[module]```. You can test different data sets in the `npirbatch.rs` file `test` module.
